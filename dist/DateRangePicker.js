...
var DateRangePicker = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    fireScrollEvent: _react2['default'].PropTypes.number, // Overrides values derived from initialDate/initialRange
    ...
    moveForward: _react2['default'].PropTypes.func, // triggered when a date is highlighted (hovered)
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: this.cx({ element: null }) ,onScroll:this.handleScroll},
      calendars.toJS()
      );
  }
});
